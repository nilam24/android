...
import in.cdac.sunshineapp.data.SunshinePreferences;
...
public class SunshineWeatherUtils {
    ...
    public static String formatTemperature(Context context, double temperature)
    {
        ...
        if(SunshinePreferences.isMetric(context))
        {
            ...
            temperatureFormatResourceId=R.string.format_temperature_farenheit;
    ...
    public static String getFormatedWind(Context context,float windSpeed,float degrees)
    {
